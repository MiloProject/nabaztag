...
data = {
	...
	".*(raconte moi|fais moi|tu connais).*(blague|histoire).*": ["joue:blague_du_papier","joue:blague_racine", "joue:blague_binaire"],
	".*(qui es tu|parle moi de toi|(raconte moi|quelle est) ton histoire|(présente toi|peux tu te présenter))": ["joue:présentation"],
